...
path(
    ...
    path('vehicle/<int:vehicle_pk>/alert/add/', 
        views.maintenance_alert_create_view, name='maintenance_alert_add'),
    path('vehicle/<int:vehicle_pk>/alert/<int:pk>/edit/', 
        views.maintenance_alert_edit_view, name='maintenance_alert_edit'),
    path('vehicle/<int:vehicle_pk>/alert/<int:pk>/delete/', 
        views.maintenance_alert_delete_view, name='maintenance_alert_delete'),
